...
int main (int argc, char *argv[])
{
	...
	MPI_Scatter(v_send, MULTI, MPI_INT, v_recv, MULTI, MPI_INT, 0,
		MPI_COMM_WORLD);
	 ...
	 */
	printf("[INFO] Process '%d' has elements %d %d %d %d %d.\n", rank,
	...
	MPI_Gather(v_recv, MULTI, MPI_INT, result, MULTI, MPI_INT, 0,
		MPI_COMM_WORLD);
